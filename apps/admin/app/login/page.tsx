  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-8 bg-black">
      <div className="card w-full max-w-md p-8">
        <div className="mb-6">
          <p className="text-xs text-zinc-500 font-light tracking-widest uppercase mb-3">Zuti Admin</p>
          <h1 className="font-brand font-semibold text-2xl tracking-tight text-white">Sign in</h1>
          <p className="mt-1 text-sm text-zinc-500 font-light">Use your existing Zuti credentials. Access is limited to configured super-admin accounts.</p>
        </div>
