      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={title}>New Action Forwarding Request</Text>
            <Text style={subtitle}>Generated by {botName}</Text>
          </Section>

          <Section style={card}>
            <Row label="Action type" value={actionType} />
            ...
            <Row label="Booking reason" value={bookingReason} />
            <Row label="Preferred time" value={preferredDatetime} />
            <Row label="Action task id" value={actionTaskId} />
          </Section>
          ...
          <Text style={footer}>This is an automated action-forwarding notification from Zuti.</Text>
        </Container>
      </Body>
    </Html>
  );
